 ...
 */
public class TrapTransformer implements ClassFileTransformer {
    static String excludes = System.getProperty("trap.excludes", "");
    static String includes = System.getProperty("trap.includes", "");
    static boolean debug = System.getProperty("trap.debug") != null;
    ...
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined, ProtectionDomain protectionDomain, byte[] classfileBuffer) throws IllegalClassFormatException {
        ...
        if (className.startsWith("org/pareto4j/mousetrap")) {
            return classfileBuffer;
        }
...
//        System.err.println(className);
        try {
            ...
            cv = new TrapClassAdapter(cv, className);
//            cv = new TraceClassVisitor(cv, printWriter);
